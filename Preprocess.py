...
#col_u = ["age","tm","pos","gp","g","a","pts","+/-","pim","ev","pp","sh","gw","ev","pp","sh","s","s_","toi","fowin","foloss","fo_"]
#all_nba= pd.read_table("https://raw.githubusercontent.com/kjones8812/abresler.github.io/master/data/NHL/player_data/all_player_per_game/nhl_player_per_game_data_1930_2015.csv", header= 0,sep = ',',names = col_u)
all_nba = pd.read_csv("/Users/MindKontrol/Python/GADataScience/DAT4/Forecasting All NHL Teams/all_nhl_abresler")

#all_nhl.to_csv('all_nba_abresler')

type(all_nnfl) #Data Frame
all_nfl.head(10) #Print first 10 rows
...
all_nhl.info() #missing values in: pos, age,fg.,x3p.,x2p.,ft.


#Used Web Scraping to pull togehter more advanced statistics

nba_advance = pd.read_csv("/Users/MindKontrol/Python/GADataScience/DAT4/Forecasting All NHL Teams/advanced_stats")
