# -*- coding: utf-8 -*-
"""
Created on Mon Aug 28 04:16 2015
@author: ToddJohnsen
"""
...
#Read in data 
NHL_players = pd.read_csv('C:\Users\ToddJohnsen\Documents\Data-science-project\Forecasting NHL All Star Teams\NHL_players.csv')
NHL_players_2015 = pd.read_csv('C:\Users\ToddJohnsen\Documents\Data-science-project\Forecasting NHL All Star Teams\NHL_players_2015.csv')

#Set up data for predicting 2014 teams
nhl_2014= NHL_players[NHL_players.season_end == 2014]
nhlHistoric= NHL_players[NHL_players.season_end <= 2013]

#Set up data for predicting 2015 teams

nhlHistoric2= NHL_players[NHL_players.season_end <= 2014]
nhl_2015= NHL_players_2015
